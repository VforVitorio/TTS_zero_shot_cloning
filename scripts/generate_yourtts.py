"""
Generate audio using YourTTS model with zero-shot voice cloning.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Generate speech using YourTTS with voice cloning"
    )
...
def main():
    ...
    print("=" * 60)
    print("YourTTS - Zero-Shot Voice Cloning")
    print("=" * 60)
