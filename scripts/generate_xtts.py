"""
Generate audio using XTTS v2 model with zero-shot voice cloning.
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Generate speech using XTTS v2 with voice cloning"
    )
...
def main():
    ...
    print("=" * 60)
    print("XTTS v2 - Zero-Shot Voice Cloning")
    print("=" * 60)
